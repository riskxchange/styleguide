...
var Input = function (_PureComponent) {
  ...
  _createClass(Input, [{
    ...
    get: function get() {
      ...
      return (0, _classnames2.default)('rx-input', (_cx = {
        'rx-input--blocked': this.props.blocked
      }, _defineProperty(_cx, 'rx-input--' + this.props.variant, this.props.variant), _defineProperty(_cx, 'rx-input--disabled', this.props.disabled), _cx));
    }
  }]);
